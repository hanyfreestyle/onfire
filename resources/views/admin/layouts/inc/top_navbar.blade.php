<nav class="main-header navbar navbar-expand navbar-white navbar-light {{ navBarStyle() }}">
    ...
    <ul class="navbar-nav ml-auto">
        <!-- Navbar Search -->
        @if(config('adminConfig.top_navbar_search') == true)
        <li class="nav-item">
        ...
        @if(config('adminConfig.top_navbar_messages') == true)
{{--        <li class="nav-item dropdown" >--}}
...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="{{defAdminAssets('img/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">--}}
...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="{{defAdminAssets('img/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">--}}
{{--                        <div class="media-body">--}}
{{--                            <h3 class="dropdown-item-title">--}}
{{--                                John Pierce--}}
...
{{--                    <!-- Message Start -->--}}
{{--                    <div class="media">--}}
{{--                        <img src="{{defAdminAssets('img/user3-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">--}}
{{--                        <div class="media-body">--}}
{{--                            <h3 class="dropdown-item-title">--}}
{{--                                Nora Silvester--}}
